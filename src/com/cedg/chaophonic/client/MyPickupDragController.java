...
//			int calculatePosition = ((w.getAbsoluteLeft())*10)+1;
			int calculatePosition = (w.getAbsoluteLeft()*song.getLengthInMs()/song.getWidth())+1;
			...
			if (w instanceof AudioSample){
				...
				// séquencage de l'ASS
				((AudioSampleSequenced) w).setStarttime(calculatePosition);
			}
